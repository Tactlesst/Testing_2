...
from backend.models import Designation, Empprofile, DRNTracker, Personalinfo
...
def generate_drn_for_rso(request):
    ...
    if request.method == "POST":
        ...
        track_num = generate_serial_string(lasttrack.tracking_no) if lasttrack else generate_serial_string(None, 'DT')
