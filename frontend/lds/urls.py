...
from frontend.lds.views import lds_rrso, training_details, print_rrso, print_qrtraining, add_training_participant, \
    ...
    update_idp_details, lds_trainingtitle_search, ldi_plan_details_user, lds_training_baseline, lds_training_quarters, notification_history
    

urlpatterns = [
    path('requests/', lds_rrso, name='lds_rrso'),

    path('notifications/', notification_history, name='lds_notification_history'),
    ...
    path('training-titles/<int:training_id>/baseline/', lds_training_baseline, name='lds_training_baseline'),
    path('training-titles/<int:training_id>/quarters/', lds_training_quarters, name='lds_training_quarters'),
